...
public record LeaveLobbyData(BlockPos pos) implements IVoiceData {
    ...
    public static LeaveLobbyData unpack(long packed) {
        ...
        return new LeaveLobbyData(new BlockPos(x, y, z));
    }
