...
public record JoinLobbyData(BlockPos pos) implements IVoiceData {
    ...
    public static JoinLobbyData unpack(long packed) {
        ...
        return new JoinLobbyData(new BlockPos(x, y, z));
    }
